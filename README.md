...
本文提供全面的 **[ChatGPT 中文版](https://chat.lanjingai.org)使用指南**，推荐**国内直连**的 **[ChatGPT 镜像网站](https://xsimplechat.com)**，**支持GPT-4，无需翻墙**。   
...
## 什么是 ChatGPT 中文版？
**[ChatGPT 中文版](https://chat.lanjingai.org)** 是 OpenAI 开发的 ChatGPT 模型的中文优化版本，专为中文用户服务，提供更流畅、更精准的对话体验。  
